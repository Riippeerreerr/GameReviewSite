    ...
    return(
        ...
        <div>
            <Category 
                ...
                title="RTS"
                description="Real-time strategy (RTS) games immerse players in dynamic, fast-paced strategic gameplay where
                 every decision counts. Commanding armies, managing resources, and constructing bases are pivotal as you 
                 navigate through intense battles. From commanding vast armies to outmaneuvering opponents with tactical 
                 prowess, RTS games demand strategic thinking, quick reflexes, and resource management skills. Whether 
                 you're leading historical armies or futuristic factions, every choice shapes the outcome, making RTS 
                 games a thrilling test of leadership and cunning on the virtual battlefield."
            />
        </div>
        <Divider_grey />
        <div>
